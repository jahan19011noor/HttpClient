...
export class UploaderService {
  ...
  /**
   * If uploading mulitple files, change to:
  ...
  upload(file: File) {
     ...
     * )
     * 
     * Create the request object that POST's the file
     * to an upload endpoint.
     * 
     * The 'reportProgress' option tells HttpClient to listen
     * and return
     * 
     * XHR progress events
     */
  ...
  /**
   * Return distinct message for sent, upload progress
   * & response events
   */
